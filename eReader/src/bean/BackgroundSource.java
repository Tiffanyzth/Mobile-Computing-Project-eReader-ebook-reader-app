...
public class BackgroundSource {
	...
	public static final int[] backgroundDemo = { R.drawable.theme_demo_1,
	...
	public static final int[] background = { R.drawable.theme_1,
			R.drawable.theme_2, R.drawable.theme_3, R.drawable.theme_4,
			R.drawable.theme_5, R.drawable.theme_6, R.drawable.theme_7,
